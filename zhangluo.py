"""ZhangLuo: research records and iterative program evaluation."""
import runpy
import sys
...
def main():
    ...
    if len(sys.argv) < 2 or sys.argv[1] in ('-h', '--help'):
        print('Usage: python zhangluo.py {doctor|research|era} [arguments]')
    ...
    if sys.argv[1] == 'doctor':
        ...
        raise SystemExit('Unknown engine. Run python zhangluo.py --help')
